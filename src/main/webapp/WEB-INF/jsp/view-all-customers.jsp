    ...
    <table id="customers" class="display">
        ...
        <c:forEach items="${allCustomers}" var="next">
            <tr>
                ...
                <td>${next.surname}</td>
                <td>${next.phone.id}</td>
                <td class="edit" data-id="${next.phone.id}" data-name="number" contenteditable="true">${next.phone.number}</td>
                <td class="edit" data-id="${next.phone.id}" data-name="phoneType" contenteditable="true">${next.phone.phoneType}</td>
                <td class="edit" data-id="${next.phone.id}" data-name="description" contenteditable="true">${next.phone.description}</td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
